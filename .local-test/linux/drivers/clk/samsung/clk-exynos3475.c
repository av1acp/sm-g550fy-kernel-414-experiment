...
struct exynos3475_pll_rate_table table_cpu[] = {
	/* rate            p,      m,      s,      k */
...
struct exynos3475_pll_rate_table table_mem0[] = {
	/* rate            p,      m,      s,      k */
...
struct exynos3475_pll_rate_table table_media[] = {
	/* rate            p,      m,      s,      k */
	{ 1334000000U,    13,    667,      0,      0 },
	{ 1332000000U,    13,    666,      0,      0 },
};

struct exynos3475_pll_rate_table table_bus[] = {
	/* rate            p,      m,      s,      k */
	{ 825000000U,     26,    825,      0,      0 },
	{ 800000000U,     13,    400,      0,      0 },
};

struct exynos3475_pll_rate_table table_g3d[] = {
	/* rate            p,      m,      s,     k */
...
struct exynos3475_pll_rate_table table_usb[] = {
	/* rate            p,      m,      s,     k */
	{  50000000U,	  13,    400,      4,     0 },
	{  24000000U,	  13,    384,      5,     0 },
};

struct exynos3475_pll_rate_table table_aud[] = {
	/* rate            p,      m,      s,     k */
	{ 393216000U,	   3,    181,      2, 31740 },
	{ 294912000U,	   3,    136,      2,  7421 },
};

static struct exynos3475_composite_pll exynos3475_pll_clks[] __refdata = {
	/* CPU */
...
static struct exynos3475_composite_mux exynos3475_mux_clks[] __refdata = {
	/* CPU */
...
static struct exynos3475_composite_divider exynos3475_div_clks[] __refdata = {
	/* BUS0 */
...
static struct exynos3475_usermux exynos3475_usermux_clks[] __refdata = {
	/* BUS0 */
...
static struct exynos3475_gate exynos3475_gate_clks[] __initdata = {
	/* BUS0 */
#ifndef ALWAYS_ON_CLK
...
struct exynos3475_fixed_rate exynos3475_fixed_rate_ext_clks[] __initdata = {
	FRATE(oscclk, "fin_pll", NULL, CLK_IS_ROOT, 0),
};

struct exynos3475_fixed_rate exynos3475_fixed_rate_clks[] __initdata = {
...
struct exynos3475_fixed_factor exynos3475_fixed_factor_clks[] __initdata = {
...
static void __init exynos3475_clk_init(struct device_node *np)
{
	 ...
	 */
	exynos3475_clk_context_init(np, 0, nr_clks, (unsigned long *)exynos3475_clk_regs,
			ARRAY_SIZE(exynos3475_clk_regs), NULL, 0);
	exynos3475_register_of_fixed_ext(exynos3475_fixed_rate_ext_clks,
			ARRAY_SIZE(exynos3475_fixed_rate_ext_clks),
			ext_clk_match);
	exynos3475_register_comp_pll(exynos3475_pll_clks,
			ARRAY_SIZE(exynos3475_pll_clks));
	exynos3475_register_fixed_rate(exynos3475_fixed_rate_clks,
			ARRAY_SIZE(exynos3475_fixed_rate_clks));
	exynos3475_register_fixed_factor(exynos3475_fixed_factor_clks,
			ARRAY_SIZE(exynos3475_fixed_factor_clks));
	exynos3475_register_comp_mux(exynos3475_mux_clks,
			ARRAY_SIZE(exynos3475_mux_clks));
	exynos3475_register_comp_divider(exynos3475_div_clks,
			ARRAY_SIZE(exynos3475_div_clks));
	exynos3475_register_usermux(exynos3475_usermux_clks,
			ARRAY_SIZE(exynos3475_usermux_clks));
	exynos3475_register_gate(exynos3475_gate_clks,
