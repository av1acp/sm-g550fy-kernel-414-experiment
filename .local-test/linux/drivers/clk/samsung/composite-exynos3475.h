...
#ifndef __EXYNOS3475_CLK_COMPOSITE_H
#define __EXYNOS3475_CLK_COMPOSITE_H
...
/* Vendor 3.10 tree flag; no direct 4.14 equivalent. */
#ifndef CLK_IS_ROOT
#define CLK_IS_ROOT 0
#endif

/*
 * struct exynos3475_clk_reg_dump: register dump of clock controller registers.
 * @offset: clock register offset from the controller base address.
 * @value: the value to be register at offset.
 */
struct exynos3475_clk_reg_dump {
	unsigned long	offset;
	u32		value;
};

/*
 * struct exynos3475_fixed_rate_clock: information about fixed-rate clock
...
extern void __init exynos3475_register_fixed_rate(
		struct exynos3475_fixed_rate *list, unsigned int nr_clk);
/*
 * struct exynos3475_fixed_factor_clock: information about fixed-factor clock
 * @id: platform specific id of the clock.
 ...
 */
struct exynos3475_fixed_factor {
	unsigned int		id;
	char			*name;
	const char		*parent_name;
	unsigned long		mult;
...
extern void __init exynos3475_register_fixed_factor(
...
struct exynos3475_pll_rate_table {
	long rate;
	unsigned int pdiv;
	unsigned int mdiv;
	unsigned int sdiv;
...
/*
 * struct exynos3475_composite_pll: information about composite-pll clocks
 ...
 */
struct exynos3475_composite_pll {
	struct clk_hw				hw;
	unsigned int				id;
	const char				*name;
	enum pll_type				type;
	...
	const struct exynos3475_pll_rate_table	*rate_table;
...
extern void exynos3475_register_comp_pll(struct exynos3475_composite_pll *pll_list,
					unsigned int nr_pll);

#define PNAME(x) static const char *x[]
/*
 * struct exynos3475_composite_mux: information about composite-mux clocks
 * @id: id of the clock for binding with device tree.
 ...
 */
struct exynos3475_composite_mux {
	struct clk_hw			hw;
	unsigned int			id;
	const char			*name;
	const char			**parents;
...
extern void exynos3475_register_comp_mux(struct exynos3475_composite_mux *mux_list,
					unsigned int nr_mux);

/*
 * struct exynos3475_composite_divider: information about composite-divider clocks
 * @id: id of the clock for binding with device tree.
 ...
 * @alias: optional name. recommend no more than 15 characters.
 */
struct exynos3475_composite_divider {
	struct clk_hw			hw;
	unsigned int			id;
	const char			*name;
	const char			*parent_name;
...
extern void exynos3475_register_comp_divider(struct exynos3475_composite_divider *div_list,
					unsigned int nr_div);

#define CLK_GATE_ENABLE		BIT(20)
#define CLK_ON_CHANGING		BIT(7)
/*
 * struct exynos3475_gate: information about gate clocks
 * @id: id of the clock for binding with device tree.
 * @name:
 * @parent_name:
 * @reg:
...
extern void __init exynos3475_register_gate(struct exynos3475_gate *gate_list,
				unsigned int nr_gate);

struct clk_exynos3475_usermux {
	struct clk_hw		hw;
	void __iomem		*sel_reg;
	u8			sel_bit;
	void __iomem		*stat_reg;
...
/*
 * struct exynos3475_composite_usermux: information about usermux clocks
 * @id: id of the clock for binding with device tree.
...
extern void __init exynos3475_register_usermux(struct exynos3475_usermux *list,
			unsigned int nr_usermux);
extern void __init exynos3475_clk_context_init(struct device_node *np, void __iomem *base,
		unsigned long nr_clks, unsigned long *rdump,
		unsigned long nr_rdump, unsigned long *soc_rdump,
		unsigned long nr_soc_rdump);

extern void __init exynos3475_register_of_fixed_ext(
			struct exynos3475_fixed_rate *fixed_rate_clk,
			unsigned int nr_fixed_rate_clk,
			struct of_device_id *clk_matches);

#endif /* __EXYNOS3475_CLK_COMPOSITE_H */
